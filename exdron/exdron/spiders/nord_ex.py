...
#         yield scrapy.Request(url='https://www.nord-ex.com/Catalog/',callback=self.parse,dont_filter=True)

#     def parse(self,response):
#         links = response.xpath("//div[@class='filtering_box']/div/div/a/@href")
#         for link in links:
...
#         links = response.xpath("//div[@class='td pi_desc']/h2[@class='pid_title']/a/@href")
